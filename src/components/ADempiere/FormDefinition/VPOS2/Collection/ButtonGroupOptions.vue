    ...
    function processOrdes() {
      ...
      if (total === 0) {
        ...
        store.dispatch('setModalDialogVPOS', {
          ...
          componentPath: () => import('@/components/ADempiere/FormDefinition/VPOS2/DialogInfo/openBalance.vue'),
          isShowed: true
        })
      } else {
        store.dispatch('setModalDialogVPOS', {
          ...
          componentPath: () => import('@/components/ADempiere/FormDefinition/VPOS2/DialogInfo/overdrawnInvoice.vue'),
          isShowed: true
        })
      }
    }
