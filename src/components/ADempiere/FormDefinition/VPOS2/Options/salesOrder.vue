  ...
  setup() {
    ...
    function confirmShipment() {
      ...
      store.dispatch('setModalDialogVPOS', {
        ...
        componentPath: () => import('@/components/ADempiere/FormDefinition/VPOS2/Options/Shipments/index.vue'),
        isShowed: true
      })
    }
    ...
    function returnProduct() {
      ...
      store.dispatch('setModalDialogVPOS', {
        ...
        componentPath: () => import('@/components/ADempiere/FormDefinition/VPOS2/Options/RMA'),
        isShowed: true
      })
    }
