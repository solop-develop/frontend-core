...
import paymentMethods from '@/components/ADempiere/FormDefinition/VPOS2/Options/cashManagement/cashOpening/fields/paymentMethods.vue'
import collectionAgent from '@/components/ADempiere/FormDefinition/VPOS2/Options/cashManagement/cashOpening/fields/collectionAgent.vue'
import cashBank from '@/components/ADempiere/FormDefinition/VPOS2/Options/cashManagement/cashOpening/fields/cashBank.vue'
import currency from '@/components/ADempiere/FormDefinition/VPOS2/Options/cashManagement/cashOpening/fields/currency.vue'
import CardPayments from '@/components/ADempiere/FormDefinition/VPOS2/Collection/Payments/CardPayments.vue'
  ...
  setup() {
    ...
    function openCahs() {
      store.dispatch('setModalDialogVPOS', {
        ...
        componentPath: () => import('@/components/ADempiere/FormDefinition/VPOS2/Options/cashManagement/cashOpening/panel.vue'),
        isShowed: true
      })
    }
