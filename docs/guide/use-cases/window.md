...
2. Type in the name of the Window you wish to search.
3. Select Views
##### Vue Desktop Version:
...
### Open Window from Process Browser

In ADempiere you can currently access a window from a field that is in another that is related, as shown below.
...
### Open Window from Smart Browser

In ADempiere you can currently access a window from the **Smart Browser**, as shown below.
